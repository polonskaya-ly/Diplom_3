...
class RecoveryPage:
    ...
    def input_email_to_field(self):
        self.driver.find_element(*RecoveryPageLocators.EMAIL_FIELD).send_keys(TestData.email)
    ...
    def check_current_url_recovery_password(self):
        assert Helper(self.driver).get_current_url() == UrlConfig.domain + UrlConfig.recovery_password_path
